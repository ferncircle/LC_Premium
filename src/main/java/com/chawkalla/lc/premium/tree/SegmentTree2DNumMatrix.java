...
The idea is quite similar to 1D solution. The major difference is that each TreeNode now has 4 children instead of 2.
 *
 */
public class SegmentTree2DNumMatrix {

	TreeNode root;
	public SegmentTree2DNumMatrix(int[][] matrix) {
	    if (matrix.length == 0) {
	        root = null;
	    } else {
