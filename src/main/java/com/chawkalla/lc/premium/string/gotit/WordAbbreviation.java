...
If there are any conflict, that is more than one words share the same abbreviation, a longer prefix is used instead of only 
the first character until making the map from word to abbreviation become unique. In other words, a final abbreviation cannot
...
public class WordAbbreviation {
	...
	public static void main(String[] args) {
		...
		System.out.println(new WordAbbreviation().wordsAbbreviation(Arrays.asList(new String[]{
